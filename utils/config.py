...
eval_data_path = os.path.join(root_dir, "ptr_data/phrases_finished_files/chunked/val_00*")
decode_data_path = os.path.join(root_dir, "ptr_data/phrases_finished_files/test.bin")
#decode_data_path = os.path.join(root_dir, "ptr_data/phrases_finished_files/chunked/test_000.bin")
vocab_path = os.path.join(root_dir, "ptr_data/phrases_finished_files/vocab")
val_data_path = os.path.join(root_dir, "ptr_data/phrases_finished_files/chunked/val_000.bin")
